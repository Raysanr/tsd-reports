...
/** One TSA row's raw numbers for one day — see the
...
{
    protected $fillable = [
        'tsa_sales_row_id', 'entry_date', 'gross_sales', 'net_income', 'ads_spent',
    ...
    {
        return $this->belongsTo(TsaSalesRow::class, 'tsa_sales_row_id');
    }
}
