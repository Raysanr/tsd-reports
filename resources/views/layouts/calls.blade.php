...
<aside id="sidebar"
    ...
    <nav class="relative flex-1 px-3 py-5 space-y-1 overflow-y-auto">
        ...
        {{-- Opened to a TSA too (explicit follow-up, 2026-09-02: "i want
             tsa can see access this tabs — dashboard, leads, call log") —
             moved out of the admin-only block below since a TSA's own view
             here is already correctly scoped to just their own row
             (CallLogController::index()'s own comment). --}}
