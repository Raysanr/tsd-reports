{{-- CSV-download + PNG-snapshot icon pair for a report table.
     Include with:
...
<div class="flex items-center gap-1 shrink-0">
    ...
    <button type="button" data-export-png="{{ $target }}" data-export-name="{{ $name }}"
            ...
            class="p-1.5 rounded-lg text-slate-400 hover:text-slate-600 hover:bg-slate-100 transition-colors cursor-pointer disabled:cursor-wait">
        <svg class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="1.8" viewBox="0 0 24 24">
