...
<div class="mb-6 flex items-center gap-4 bg-red-50 dark:bg-red-950/40 border border-red-200 dark:border-red-800 rounded-xl px-6 py-4">
    ...
    <p class="text-sm font-mono text-red-700 dark:text-red-400">
        {{ $dbError }}
    </p>
</div>
@endif
...
@if(!$apiConnected)
<div class="mb-6 flex items-center gap-4 bg-yellow-50 dark:bg-yellow-950/40 border border-yellow-200 dark:border-yellow-900 rounded-xl px-6 py-4">
    ...
    <p class="text-sm font-mono text-yellow-700 dark:text-yellow-400">
...
<div class="mb-6 flex items-start gap-4 bg-orange-50 dark:bg-orange-950/40 border border-orange-200 dark:border-orange-800 rounded-xl px-6 py-4">
    <svg class="w-5 h-5 text-orange-500 shrink-0 mt-0.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
        <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v2m0 4h.01M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/>
    </svg>
    <div class="text-sm font-mono text-orange-700 dark:text-orange-400 space-y-1">
...
{{-- UI/UX review finding: all 8 KPI cards fully stacked to one column even
     on the narrowest phones — a long scroll of summary tiles before any
     actual report content. 2 columns from the smallest breakpoint up cuts
     that scroll roughly in half; still readable at ~375px since each card's
     own content (icon + short label + one number) doesn't need much width. --}}
<div class="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-5 mb-8">
    ...
    <div class="stat-card bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 p-3 sm:p-5 shadow-sm flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-2 sm:gap-4">
        <div class="w-9 h-9 sm:w-12 sm:h-12 rounded-full flex items-center justify-center shrink-0" style="background:rgba(202,138,4,0.12)">
            <svg class="w-4.5 h-4.5 sm:w-6 sm:h-6" style="color:#CA8A04" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
    ...
    <div class="stat-card bg-white dark:bg-slate-900 rounded-xl border border-yellow-200 dark:border-yellow-900 p-3 sm:p-5 shadow-sm flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-2 sm:gap-4">
    ...
    <div class="stat-card bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 p-3 sm:p-5 shadow-sm flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-2 sm:gap-4">
        <div class="w-9 h-9 sm:w-12 sm:h-12 rounded-full bg-amber-50 dark:bg-amber-950/40 flex items-center justify-center shrink-0">
            <svg class="w-4.5 h-4.5 sm:w-6 sm:h-6 text-amber-500" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div class="min-w-0 w-full">
            ...
            <p class="text-sm sm:text-lg font-bold text-slate-800 dark:text-slate-100 font-mono leading-none truncate" title="{{ $topTsa->display_name }}">
                {{ $topTsa->display_name }}
            </p>
    ...
    <div class="stat-card bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 p-3 sm:p-5 shadow-sm flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-2 sm:gap-4">
        <div class="w-9 h-9 sm:w-12 sm:h-12 rounded-full bg-blue-50 dark:bg-blue-950/40 flex items-center justify-center shrink-0">
            <svg class="w-4.5 h-4.5 sm:w-6 sm:h-6 text-blue-600" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
    ...
    <div class="stat-card bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 p-3 sm:p-5 shadow-sm flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-2 sm:gap-4">
        <div class="w-9 h-9 sm:w-12 sm:h-12 rounded-full bg-emerald-50 dark:bg-emerald-950/40 flex items-center justify-center shrink-0">
            <svg class="w-4.5 h-4.5 sm:w-6 sm:h-6 text-emerald-600" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
    ...
    <div class="stat-card bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 p-3 sm:p-5 shadow-sm flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-2 sm:gap-4">
        <div class="w-9 h-9 sm:w-12 sm:h-12 rounded-full bg-green-50 dark:bg-green-950/40 flex items-center justify-center shrink-0">
            <svg class="w-4.5 h-4.5 sm:w-6 sm:h-6 text-green-600" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
    ...
    <div class="stat-card bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 p-3 sm:p-5 shadow-sm flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-2 sm:gap-4">
        <div class="w-9 h-9 sm:w-12 sm:h-12 rounded-full bg-violet-50 dark:bg-violet-950/40 flex items-center justify-center shrink-0">
            <svg class="w-4.5 h-4.5 sm:w-6 sm:h-6 text-violet-600" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
...
<div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden flex flex-col">
    ...
    <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm px-5 py-4 flex flex-col">
        <div class="flex items-center justify-between mb-3">
            <div>
                <h2 class="text-sm font-bold text-slate-700 dark:text-slate-200 font-mono">Hourly Activity</h2>
                <p class="text-xs font-mono text-slate-400 mt-0.5">Calls per hour, today</p>
            </div>
            <div class="text-right">
                <p class="text-2xl font-bold text-slate-800 dark:text-slate-100 font-mono leading-none">{{ $hourlyActivity->sum() }}</p>
...
<div class="mt-6">
    <div class="flex items-center justify-between mb-3">
        <div>
            <h2 class="text-sm font-bold text-slate-700 dark:text-slate-200 font-mono">Team Comparison</h2>
            ...
            <div class="p-5">
                <div class="flex items-center justify-between mb-4">
                    <div class="flex items-center gap-3">
                        ...
                        <p class="text-sm font-bold font-mono text-slate-700 dark:text-slate-200">{{ $team['name'] }}</p>
                    </div>
                    @if($isLeader)
                    <span class="inline-flex items-center gap-1 px-2 py-1 rounded-full text-[10px] font-bold font-mono uppercase tracking-wide bg-emerald-50 dark:bg-emerald-950/40 text-emerald-700 dark:text-emerald-400">
                ...
                <div class="grid grid-cols-2 gap-4 mb-4">
                    <div>
                        <p class="text-2xl font-bold text-slate-800 dark:text-slate-100 font-mono leading-none" style="font-variant-numeric: tabular-nums">{{ $team['total_calls'] }}</p>
                        <p class="text-xs font-mono text-slate-400 mt-1">calls today</p>
                    </div>
                    <div>
                        <p class="text-2xl font-bold text-slate-800 dark:text-slate-100 font-mono leading-none" style="font-variant-numeric: tabular-nums">{{ $team['upsell_count'] }}</p>
                ...
                <div class="mb-4">
                    <div class="flex items-center justify-between mb-1.5">
                        ...
                        <p class="text-xs font-mono font-bold text-slate-700 dark:text-slate-200">{{ number_format($team['upsell_rate'], 1) }}%</p>
                    </div>
...
<div class="mt-6">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {{-- By brand --}}
        <div class="bg-white dark:bg-slate-900 rounded-xl border border-yellow-200 dark:border-yellow-900 shadow-sm overflow-hidden">
            <div class="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
                <h3 class="text-sm font-bold text-slate-700 dark:text-slate-200 font-mono">By Brand</h3>
            </div>
        ...
        <div class="bg-white dark:bg-slate-900 rounded-xl border border-yellow-200 dark:border-yellow-900 shadow-sm overflow-hidden">
            <div class="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
                <h3 class="text-sm font-bold text-slate-700 dark:text-slate-200 font-mono">By TSA</h3>
            </div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
    ...
    <div class="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden">
        <div class="px-5 py-4 border-b border-slate-100 dark:border-slate-700">
            <h2 class="text-sm font-bold text-slate-700 dark:text-slate-200 font-mono">Top Upsell Products</h2>
